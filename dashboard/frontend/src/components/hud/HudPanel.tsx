  ...
  return (
    <div
      ...
      style={{
        ...
        border: "1px solid rgba(0, 196, 188, 0.14)",
        borderRadius: "14px",
        boxShadow:
          "inset 0 1px 0 rgba(0, 196, 188, 0.18), 0 0 28px rgba(0, 196, 188, 0.07), 0 8px 32px rgba(0, 0, 0, 0.45)",
      }}
    >
      {id && (
        <div
          className="mb-2 flex items-center justify-between pb-2"
          style={{ borderBottom: "1px solid rgba(0, 196, 188, 0.08)" }}
        >
          ...
          <div className="flex items-center gap-2">
            <div
              ...
              style={{ borderRadius: "999px", background: "rgba(0, 196, 188, 0.12)" }}
            >
              <div
                className="h-full hud-progress-fill"
                style={{
                  width: `${progressValue ?? 100}%`,
                  background: "rgba(0, 196, 188, 0.55)",
                  borderRadius: "999px",
                }}
              />
            </div>
