  ...
  return (
    <div className="relative h-full min-h-0 bg-[#020d08] font-mono overflow-y-auto">
      ...
      <div className="pointer-events-none absolute inset-0"
        style={{ background: "radial-gradient(ellipse at 50% 0%, rgba(0, 200, 100,0.08), transparent 50%), radial-gradient(ellipse at 50% 100%, rgba(0, 160, 80,0.06), transparent 50%)" }} />
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-8">
        ...
        <div className="relative mb-8">
          <div className="absolute left-0 top-0 bottom-0 w-0.5 transition-all duration-300"
            style={{
              background: loading
                ...
                : "linear-gradient(180deg, transparent, rgba(0, 180, 90,0.5), transparent)",
          ...
          <input
            ...
            style={{ borderBottom: "1px solid rgba(0, 180, 90,0.25)", caretColor: "#22d3ee" }}
          />
          <button
            onClick={run}
        ...
        {result && (
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-4 py-2 text-[10px]"
              style={{ borderBottom: "1px solid rgba(0, 180, 90,0.1)" }}>
                    ...
                    <div className="flex gap-4 p-4">
                      ...
                      <div className="flex-1 min-w-0 pr-16">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <ScoreBar label="RECENCY"  value={r.recency_contribution}  color="#00cc6a" />
          ...
          <div className="flex flex-col items-center justify-center py-20">
            <div className="mb-6 relative">
              <div
                ...
                style={{ boxShadow: "0 0 40px rgba(0, 180, 90,0.08)" }}
              >
