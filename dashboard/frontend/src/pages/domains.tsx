  ...
  return (
    <div className="relative h-full min-h-0 bg-[#020d0d] font-mono overflow-y-auto">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-8">
        ...
        {/* Domain list */}
        {loading ? (
          <div className="text-[10px] uppercase tracking-widest text-emerald-500/50 animate-pulse py-8 text-center">
            LOADING DOMAINS...
          </div>
        ) : (
            ...
            {domains.map((d, idx) => {
              ...
              return (
                <div key={d.name}
                  ...
                  style={{
                    background: isOpen ? "rgba(0, 255, 136,0.04)" : "rgba(0,5,16,0.6)",
