  ...
  return (
    <div className="relative h-full min-h-0 bg-[#000510] font-mono overflow-y-auto">
      ...
      <div className="pointer-events-none absolute inset-0"
        style={{ background: "radial-gradient(ellipse at 0% 0%, rgba(59,130,246,0.08), transparent 40%), radial-gradient(ellipse at 100% 100%, rgba(168,85,247,0.06), transparent 40%)" }} />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className="text-[9px] uppercase tracking-[0.3em] text-cyan-600/60">// SYS.CONFIG</span>
          </div>
        ...
        {cfg === null ? (
          ...
          <div className="border border-cyan-400/15 rounded-sm overflow-hidden"
            style={{
              background: "rgba(0,5,16,0.7)",
              boxShadow: "0 0 40px rgba(6,182,212,0.08), inset 0 0 30px rgba(6,182,212,0.03)"
            }}>

            {/* Panel header */}
            <div className="flex items-center justify-between px-4 py-2.5 border-b border-cyan-400/10"
              style={{ background: "rgba(6,182,212,0.04)" }}>
              <div className="flex items-center gap-3">
                <div className="h-2 w-2 rounded-full bg-cyan-400"
                  style={{ boxShadow: "0 0 6px rgba(34,211,238,0.8)", animation: "pulse 2s ease-in-out infinite" }} />
                <span className="text-[9px] uppercase tracking-[0.2em] text-cyan-500/70">
                  // CONFIG.EDITOR
                </span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div className="h-0.5 w-16 bg-white/5 rounded-full overflow-hidden">
                  <div className="h-full bg-cyan-400/50 rounded-full" style={{ width: "100%" }} />
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              {/* Line numbers gutter */}
              <div className="absolute left-0 top-0 bottom-0 w-10 border-r border-cyan-400/8 pointer-events-none"
            ...
            {/* Footer / actions */}
            <div className="flex items-center justify-between px-4 py-3 border-t border-cyan-400/10"
              ...
              <div className="flex items-center gap-2 text-[10px]">
                {status === "saving" && (
                  <>
                    ...
                    <span className="text-cyan-400/70 uppercase tracking-wider">SAVING...</span>
                  </>
                )}
                {status === "saved" && (
                  <>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: isDirty ? "0 0 12px rgba(6,182,212,0.2)" : "none",
                  }}
                >
